...
class Game implements GameControls {
    ...
    public void playRound(String input) {
        // DEFINS validAttack AS false, WILL REMAIN false TILL validAttack returns true
        ...
        for (int i = 0; i < numOfShips; i++) {
            ...
            // IF A HIT IS SUCCSESSFUL THEN CHANGES OPPONENT GAME GRID INDEX TO "X"
            // ALSO NOTIFIES USER OF WHAYT SHIP HAS BEEN HIT
            if (validAttack == true) {
